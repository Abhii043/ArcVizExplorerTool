...
void ARoadConstructor::GenerateRoad(const FVector& Dimensions)
{
	...
	if (RoadMaterial) { ProceduralMeshComponent->SetMaterial(0, RoadMaterial); }
}

void ARoadConstructor::ApplyMaterialToRoad(UMaterialInterface* Material)
{
